...
package com.borhan.delegates.metadataProfile
{
	...
	import com.borhan.commands.metadataProfile.MetadataProfileUpdateViewsFromFile;
	...
	public class MetadataProfileUpdateViewsFromFileDelegate extends WebDelegateBase
	{
		...
		public function MetadataProfileUpdateViewsFromFileDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
