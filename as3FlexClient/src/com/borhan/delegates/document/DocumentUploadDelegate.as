...
// @ignore
// ===================================================================================================
package com.borhan.delegates.document
{
	...
	import com.borhan.commands.document.DocumentUpload;
	...
	public class DocumentUploadDelegate extends WebDelegateBase
	{
		...
		public function DocumentUploadDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
