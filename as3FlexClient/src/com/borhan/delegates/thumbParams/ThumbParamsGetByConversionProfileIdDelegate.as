...
// @ignore
// ===================================================================================================
package com.borhan.delegates.thumbParams
{
	import com.borhan.vo.BorhanThumbParams;BorhanThumbParams;;
	...
	{
		public function ThumbParamsGetByConversionProfileIdDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
