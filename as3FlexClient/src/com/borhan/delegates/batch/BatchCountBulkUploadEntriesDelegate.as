...
// @ignore
// ===================================================================================================
package com.borhan.delegates.batch
{
	import com.borhan.vo.BorhanKeyValue;BorhanKeyValue;;
	...
	public class BatchCountBulkUploadEntriesDelegate extends WebDelegateBase
	{
		public function BatchCountBulkUploadEntriesDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
