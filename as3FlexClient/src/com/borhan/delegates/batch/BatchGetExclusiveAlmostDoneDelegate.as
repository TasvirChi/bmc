...
package com.borhan.delegates.batch
{
	...
	public class BatchGetExclusiveAlmostDoneDelegate extends WebDelegateBase
	{
		public function BatchGetExclusiveAlmostDoneDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
