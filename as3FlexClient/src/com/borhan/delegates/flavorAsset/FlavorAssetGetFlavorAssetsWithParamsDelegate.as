...
{
	import com.borhan.vo.BorhanFlavorAssetWithParams;BorhanFlavorAssetWithParams;;
	...
	{
		public function FlavorAssetGetFlavorAssetsWithParamsDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
