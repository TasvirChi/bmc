...
package com.borhan.commands.liveChannel
{
	...
	import com.borhan.delegates.liveChannel.LiveChannelAppendRecordingDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Append recorded video to live entry
	**/
	public class LiveChannelAppendRecording extends BorhanCall
	{
		...
		**/
		public function LiveChannelAppendRecording( entryId : String,assetId : String,mediaServerIndex : String,resource : BorhanDataCenterContentResource,duration : Number,isLastChunk : Boolean=false )
		{
			service= 'livechannel';
