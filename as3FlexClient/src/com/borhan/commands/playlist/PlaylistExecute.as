...
package com.borhan.commands.playlist
{
	...
	**/
	public class PlaylistExecute extends BorhanCall
	{
		...
		**/
		public function PlaylistExecute( id : String,detailed : String='',playlistContext : BorhanContext=null,filter : BorhanMediaEntryFilterForPlaylist=null,pager : BorhanFilterPager=null )
		{
			service= 'playlist';
			action= 'execute';
