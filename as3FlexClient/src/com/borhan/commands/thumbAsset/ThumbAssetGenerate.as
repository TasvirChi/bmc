...
package com.borhan.commands.thumbAsset
{
	...
	import com.borhan.delegates.thumbAsset.ThumbAssetGenerateDelegate;
	import com.borhan.net.BorhanCall;

	/**
	**/
	public class ThumbAssetGenerate extends BorhanCall
	{
		...
		**/
		public function ThumbAssetGenerate( entryId : String,thumbParams : BorhanThumbParams,sourceAssetId : String = null )
		{
			service= 'thumbasset';
			action= 'generate';
