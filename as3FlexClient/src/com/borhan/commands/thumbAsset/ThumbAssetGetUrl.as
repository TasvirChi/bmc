...
package com.borhan.commands.thumbAsset
{
	...
	import com.borhan.delegates.thumbAsset.ThumbAssetGetUrlDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Get download URL for the asset
	**/
	public class ThumbAssetGetUrl extends BorhanCall
	{
		...
		**/
		public function ThumbAssetGetUrl( id : String,storageId : int=int.MIN_VALUE,thumbParams : BorhanThumbParams=null )
		{
			service= 'thumbasset';
			action= 'getUrl';
