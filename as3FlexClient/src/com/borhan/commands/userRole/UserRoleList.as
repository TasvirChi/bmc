...
package com.borhan.commands.userRole
{
	...
	import com.borhan.delegates.userRole.UserRoleListDelegate;
	...
	**/
	public class UserRoleList extends BorhanCall
	{
		public var filterFields : String;
		
		/**
		* @param filter BorhanUserRoleFilter
		* @param pager BorhanFilterPager
		**/
		public function UserRoleList( filter : BorhanUserRoleFilter=null,pager : BorhanFilterPager=null )
		{
			service= 'userrole';
			action= 'list';
