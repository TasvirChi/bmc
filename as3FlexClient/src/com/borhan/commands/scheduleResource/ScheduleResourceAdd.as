...
package com.borhan.commands.scheduleResource
{
	...
	import com.borhan.delegates.scheduleResource.ScheduleResourceAddDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Allows you to add a new BorhanScheduleResource object
	**/
	public class ScheduleResourceAdd extends BorhanCall
	{
		...
		**/
		public function ScheduleResourceAdd( scheduleResource : BorhanScheduleResource )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ScheduleResourceAddDelegate( this , config );
		}
	}
}
