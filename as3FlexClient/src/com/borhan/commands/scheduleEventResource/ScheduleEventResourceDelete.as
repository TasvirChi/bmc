...
{
	import com.borhan.delegates.scheduleEventResource.ScheduleEventResourceDeleteDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Mark the BorhanScheduleEventResource object as deleted
	**/
	public class ScheduleEventResourceDelete extends BorhanCall
	{
		...
		**/
		public function ScheduleEventResourceDelete( scheduleEventId : int,scheduleResourceId : int )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new ScheduleEventResourceDeleteDelegate( this , config );
		}
	}
}
