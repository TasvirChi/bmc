...
{
	import com.borhan.delegates.jobs.JobsGetConvertProfileStatusDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* batch getConvertProfileStatusAction returns the status of convert task
	**/
	public class JobsGetConvertProfileStatus extends BorhanCall
	{
		...
		* @param jobId int
		**/
		public function JobsGetConvertProfileStatus( jobId : int )
		{
			service= 'jobs';
