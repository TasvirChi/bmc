...
package com.borhan.commands.baseEntry
{
	...
	import com.borhan.delegates.baseEntry.BaseEntryAddContentDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Attach content resource to entry in status NO_MEDIA
	**/
	public class BaseEntryAddContent extends BorhanCall
	{
		...
		**/
		public function BaseEntryAddContent( entryId : String,resource : BorhanResource )
		{
			service= 'baseentry';
			action= 'addContent';
