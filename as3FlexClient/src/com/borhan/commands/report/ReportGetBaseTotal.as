...
package com.borhan.commands.report
{
	...
	import com.borhan.delegates.report.ReportGetBaseTotalDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* report getBaseTotal action allows to get a the total base for storage reports
	**/
	public class ReportGetBaseTotal extends BorhanCall
	{
		...
		**/
		public function ReportGetBaseTotal( reportType : String,reportInputFilter : BorhanReportInputFilter,objectIds : String = null )
		{
			service= 'report';
			action= 'getBaseTotal';
