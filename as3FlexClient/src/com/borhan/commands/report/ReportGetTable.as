...
package com.borhan.commands.report
{
	...
	**/
	public class ReportGetTable extends BorhanCall
	{
		...
		**/
		public function ReportGetTable( reportType : String,reportInputFilter : BorhanReportInputFilter,pager : BorhanFilterPager,order : String = null,objectIds : String = null )
		{
			service= 'report';
			action= 'getTable';
