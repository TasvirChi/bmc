...
package com.borhan.commands.batch
{
	...
	import com.borhan.delegates.batch.BatchResetJobExecutionAttemptsDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* batch resetJobExecutionAttempts action resets the execution attempts of the job
	**/
	public class BatchResetJobExecutionAttempts extends BorhanCall
	{
		...
		**/
		public function BatchResetJobExecutionAttempts( id : int,lockKey : BorhanExclusiveLockKey,jobType : String )
		{
			service= 'batch';
