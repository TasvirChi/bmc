...
package com.borhan.commands.batch
{
	...
	import com.borhan.delegates.batch.BatchUpdateExclusiveJobDelegate;
	...
	**/
	public class BatchUpdateExclusiveJob extends BorhanCall
	{
		...
		**/
		public function BatchUpdateExclusiveJob( id : int,lockKey : BorhanExclusiveLockKey,job : BorhanBatchJob )
		{
			service= 'batch';
