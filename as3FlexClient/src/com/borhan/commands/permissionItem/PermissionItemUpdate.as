...
package com.borhan.commands.permissionItem
{
	...
	import com.borhan.delegates.permissionItem.PermissionItemUpdateDelegate;
	...
	**/
	public class PermissionItemUpdate extends BorhanCall
	{
		...
		**/
		public function PermissionItemUpdate( permissionItemId : int,permissionItem : BorhanPermissionItem )
		{
