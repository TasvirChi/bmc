...
{
	import com.borhan.delegates.genericDistributionProviderAction.GenericDistributionProviderActionAddResultsTransformDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Add results transform file to generic distribution provider action
	**/
	public class GenericDistributionProviderActionAddResultsTransform extends BorhanCall
	{
