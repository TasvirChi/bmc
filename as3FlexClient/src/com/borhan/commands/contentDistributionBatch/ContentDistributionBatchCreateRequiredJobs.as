...
// @ignore
// ===================================================================================================
package com.borhan.commands.contentDistributionBatch
{
	import com.borhan.delegates.contentDistributionBatch.ContentDistributionBatchCreateRequiredJobsDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* creates all required jobs according to entry distribution dirty flags
	**/
	public class ContentDistributionBatchCreateRequiredJobs extends BorhanCall
	{
