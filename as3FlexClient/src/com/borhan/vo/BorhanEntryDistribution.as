...
package com.borhan.vo
{
	...
	[Bindable]
	public dynamic class BorhanEntryDistribution extends BaseFlexVo
	{
		/**
		...
		**/
		...
		/**
		* @see com.borhan.types.BorhanEntryDistributionStatus
		**/
		public var status : int = int.MIN_VALUE;

		/**
		* @see com.borhan.types.BorhanEntryDistributionSunStatus
		**/
		public var sunStatus : int = int.MIN_VALUE;

		/**
		* @see com.borhan.types.BorhanEntryDistributionFlag
		**/
		...
		public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				case 'validationErrors':
					result = 'BorhanDistributionValidationError';
					break;
			}
			return result;
		}
