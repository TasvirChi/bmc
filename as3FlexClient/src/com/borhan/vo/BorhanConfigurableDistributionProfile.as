...
package com.borhan.vo
{
	...
	[Bindable]
	public dynamic class BorhanConfigurableDistributionProfile extends BorhanDistributionProfile
	{
		/**
		**/
		...
		override public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				case 'fieldConfigArray':
					result = 'BorhanDistributionFieldConfig';
					break;
				case 'itemXpathsToExtend':
					result = 'BorhanExtendingItemMrssParameter';
					break;
				default:
