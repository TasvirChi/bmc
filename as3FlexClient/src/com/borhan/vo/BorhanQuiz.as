...
package com.borhan.vo
{
	...
	[Bindable]
	public dynamic class BorhanQuiz extends BaseFlexVo
	{
		/**
		**/
		...
		**/
		public var showResultOnAnswer : int = int.MIN_VALUE;

		/**
		* @see com.borhan.types.BorhanNullableBoolean
		**/
		public var showCorrectKeyOnAnswer : int = int.MIN_VALUE;

		/**
		* @see com.borhan.types.BorhanNullableBoolean
		**/
		public var allowAnswerUpdate : int = int.MIN_VALUE;
		...
		**/ 
		public function getUpdateableParamKeys():Array
		{
			var arr : Array;
			arr = new Array();
			arr.push('uiAttributes');
			arr.push('showResultOnAnswer');
