...
package com.borhan.vo
{
	...
	[Bindable]
	public dynamic class BorhanEventNotificationTemplate extends BaseFlexVo
	{
		/**
		**/
		...
		* @see com.borhan.types.BorhanEventNotificationEventType
		**/
		public var eventType : String = null;

		/**
		* Define the object that raied the event that should trigger this notification
		* @see com.borhan.types.BorhanEventNotificationEventObjectType
		**/
		...
		public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				case 'eventConditions':
					result = 'BorhanCondition';
					break;
				case 'contentParameters':
					result = 'BorhanEventNotificationParameter';
					break;
				case 'userParameters':
					result = 'BorhanEventNotificationParameter';
					break;
