...
package com.borhan.vo
{
	...
	[Bindable]
	public dynamic class BorhanAttUverseDistributionJobProviderData extends BorhanConfigurableDistributionJobProviderData
	{
		/**
		**/
		...
		override public function getElementType(arrayName:String):String
		{
			...
			switch (arrayName) {
				case 'filesForDistribution':
					result = 'BorhanAttUverseDistributionFile';
					break;
				default:
