...
package com.borhan.commands.businessProcessServer
{
	...
	import com.borhan.delegates.businessProcessServer.BusinessProcessServerUpdateDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Update an existing Business-Process server object
	**/
	public class BusinessProcessServerUpdate extends BorhanCall
	{
		...
		**/
		public function BusinessProcessServerUpdate( id : int,businessProcessServer : BorhanBusinessProcessServer )
		{
		...
		override public function execute() : void
		{
			...
			delegate = new BusinessProcessServerUpdateDelegate( this , config );
		}
	}
}
