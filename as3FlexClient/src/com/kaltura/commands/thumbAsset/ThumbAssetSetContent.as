...
package com.borhan.commands.thumbAsset
{
	...
	import com.borhan.delegates.thumbAsset.ThumbAssetSetContentDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Update content of thumbnail asset
	**/
	public class ThumbAssetSetContent extends BorhanCall
	{
		...
		**/
		public function ThumbAssetSetContent( id : String,contentResource : BorhanContentResource )
		{
			service= 'thumbasset';
			action= 'setContent';
