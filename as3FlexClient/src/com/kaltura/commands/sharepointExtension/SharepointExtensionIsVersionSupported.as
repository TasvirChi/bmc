...
// @ignore
// ===================================================================================================
package com.borhan.commands.sharepointExtension
{
	import com.borhan.delegates.sharepointExtension.SharepointExtensionIsVersionSupportedDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Is this Borhan-Sharepoint-Server-Plugin supports minimum version of $major.$minor.$build (which is required by the extension)
	**/
	public class SharepointExtensionIsVersionSupported extends BorhanCall
	{
		...
		**/
		...
		{
			service= 'borhansharepointextension_sharepointextension';
