...
package com.borhan.commands.playReadyDrm
{
	...
	**/
	public class PlayReadyDrmGetEntryContentKey extends BorhanCall
	{
		...
		**/
		public function PlayReadyDrmGetEntryContentKey( entryId : String,createIfMissing : Boolean=false )
		{
			...
			keyArr.push('createIfMissing');
			valueArr.push(createIfMissing);
		...
		override public function execute() : void
		{
			...
			delegate = new PlayReadyDrmGetEntryContentKeyDelegate( this , config );
		}
	}
}
