...
{
	import com.borhan.delegates.businessProcessCase.BusinessProcessCaseServeDiagramDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Server business-process case diagram
	**/
	public class BusinessProcessCaseServeDiagram extends BorhanCall
	{
