...
package com.borhan.commands.batch
{
	...
	import com.borhan.delegates.batch.BatchAddBulkUploadResultDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* batch addBulkUploadResultAction action adds BorhanBulkUploadResult to the DB
	**/
	public class BatchAddBulkUploadResult extends BorhanCall
	{
		public var filterFields : String;
		
		/**
		* @param bulkUploadResult BorhanBulkUploadResult
		* @param pluginDataArray Array
		**/
		public function BatchAddBulkUploadResult( bulkUploadResult : BorhanBulkUploadResult,pluginDataArray : Array=null )
		{
			service= 'batch';
