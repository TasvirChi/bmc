...
package com.borhan.commands.documents
{
	...
	import com.borhan.delegates.documents.DocumentsAddFromEntryDelegate;
	import com.borhan.net.BorhanCall;

	/**
	* Copy entry into new entry
	**/
	public class DocumentsAddFromEntry extends BorhanCall
	{
		...
		**/
		public function DocumentsAddFromEntry( sourceEntryId : String,documentEntry : BorhanDocumentEntry=null,sourceFlavorParamsId : int=int.MIN_VALUE )
		{
