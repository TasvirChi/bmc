...
package com.borhan.delegates.metadataProfile
{
	...
	import com.borhan.commands.metadataProfile.MetadataProfileUpdateTransformationFromFile;
	...
	public class MetadataProfileUpdateTransformationFromFileDelegate extends WebDelegateBase
	{
		...
		public function MetadataProfileUpdateTransformationFromFileDelegate(call:BorhanCall, config:BorhanConfig)
		{
			super(call, config);
		}
