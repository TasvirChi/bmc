package com.borhan.bmc.events {
	 ...
	 * @author Atar
	 */
	public class BmcNavigationEvent extends Event {
		 ...
		 * dispatched by different components to ask the BMC to naivgate 
		...
		/**
		 * dispatched by BMC when the handling of a navigation request is complete.
		 * */
		...
		public function BmcNavigationEvent(type:String, module:String, subtab:String = "", data:Object = null,
