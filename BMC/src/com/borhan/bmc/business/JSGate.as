...
//			ExternalInterface.call("bmc.functions.openClipApp", entryId, mode);
		 ...
		 * 				module_name:id to return to bmc for this tab,
		...
		public static function createTabs(tabs:Array):void {
			ExternalInterface.call("bmc.utils.createTabs", tabs);
		}
		...
		public static function openIframe(url:String):void {
			ExternalInterface.call("bmc.utils.openIframe", url);
		}
		...
		public static function showFlash():void {
			ExternalInterface.call("bmc.utils.showFlash");
		}
		...
		public static function setTab(module:String, resetAll:Boolean):void {
			ExternalInterface.call("bmc.utils.setTab", module, resetAll);
		}
		...
		public static function resetTab(module:String):void {
			ExternalInterface.call("bmc.utils.resetTab", module);
			//TODO use this
		}
		...
		public static function writeUrlHash(module:String, subtab:String):void {
			ExternalInterface.call("bmc.mediator.writeUrlHash", module, subtab);
		}
		...
		public static function startEditor(entryId:String, entryName:String, editorType:int, isNewMix:Boolean):void {
			ExternalInterface.call("bmc.editors.start", entryId, entryName, editorType, isNewMix);
		}
		...
		public static function openChangeName():void {
			ExternalInterface.call("bmc.user.changeSetting", 'name');
		}
		...
		public static function openChangePwd():void {
			ExternalInterface.call("bmc.user.changeSetting", 'password');
		}
		...
		public static function openChangeEmail():void {
			ExternalInterface.call("bmc.user.changeSetting", 'email');
		}
		 ...
		 * @param uiconftag
		 */
		public static function openBcw(conversion_profile:String, uiconftag:String):void {
			ExternalInterface.call("bmc.functions.openBcw", conversion_profile,uiconftag);
		}
		...
		public static function getPanelPosition():int {
			return ExternalInterface.call("bmc.functions.getAddPanelPosition");
		}
		 ...
		 * show help pages
		 * @param baseURL  
		 * @param key	help page to show (BMC anchor, mapped to page name in JS)
		 */
		public static function openHelp(baseURL:String, key:String):void {
			ExternalInterface.call("bmc.utils.openHelp", baseURL, key);
		}
