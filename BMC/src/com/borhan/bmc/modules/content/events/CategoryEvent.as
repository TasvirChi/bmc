package com.borhan.bmc.modules.content.events
{
	...
	public class CategoryEvent extends CairngormEvent
	{
		 ...
		 * event.data is array of BorhanCategories to update 
		 */
		 ...
		 * event.data is new listing value (BorhanAppearInListType)
		 */
		 ...
		 * event.data is new contributnio policy value (BorhanContributionPolicyType)
		 */
		 ...
		 * event.data is new access value (BorhanPrivacyType)
		 */
		 ...
		 * event.data is [BorhanCategories]
		 */
		...
		/**
		 * Retrieve the parent borhan category object of the selected category.
		 */
		...
		/**
		 * get the BorhanUser that is set as owner for selected category
		 * event.data is BorhanCategory
		 */
