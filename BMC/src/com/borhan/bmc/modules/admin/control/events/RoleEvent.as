package com.borhan.bmc.modules.admin.control.events
{
	...
	public class RoleEvent extends CairngormEvent {
		...
		private var _role:BorhanUserRole;
		
		
		public function RoleEvent(type:String, role:BorhanUserRole = null, bubbles:Boolean=false, cancelable:Boolean=false)
		{
			super(type, bubbles, cancelable);
			_role = role;
		}
		
		public function get role():BorhanUserRole
		{
			return _role;
		}
	}
