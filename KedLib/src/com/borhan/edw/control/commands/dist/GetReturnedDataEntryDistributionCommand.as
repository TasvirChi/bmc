package com.borhan.edw.control.commands.dist
{
	...
	public class GetReturnedDataEntryDistributionCommand extends KedCommand
	{
		override public function execute(event:BMvCEvent):void {
			var entryDis:BorhanEntryDistribution = (event as EntryDistributionEvent).entryDistribution;
			var stringURL:String = _client.protocol + _client.domain + '/api_v3/index.php/service/contentDistribution_entryDistribution/action/serveReturnedData/actionType/1/id/' +
