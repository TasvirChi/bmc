package com.borhan.edw.business
{
	...
	public class MetadataDataParser
	{
		 ...
		 */		
		public static function toMetadataXML(entryMetadata:CustomMetadataDataVO, metadataProfile:BMCMetadataProfileVO):XML {
		...
		private static function handleEntryIdList(name:String, input:Object, parent:XML):void {
			...
			for each (var entry:Object in array) {
				...
				var id:String = (entry as BorhanBaseEntry).id;
				node.appendChild(id);
